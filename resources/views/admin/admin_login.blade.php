		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<span class="alert-danger" style="padding: 2px; text-align: center; display: block;">
						<?php
							$message=Session::get('log_error');
							if ($message) {
								echo $message;
								Session::put('log_error',null);
							}
						?>
					...
					<form class="form-horizontal" action="{{ URL::to('login_process')}}" method="post">
						{{ csrf_field() }}
						<fieldset>
