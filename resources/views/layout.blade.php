                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                           ...
                           ?>
                                <li><a href=" {{ URL::to('/login-or-registration') }} "><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            <?php
                                }
                            ?>
                            ...
                            <?php 
                             ...
                             ?>
                                <li><a href="{{ URL::to('/login-or-registration') }}"><i class="fa fa-lock"></i> Login </a></li>
                           <?php } ?>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                            ...
                            @foreach($result as $data)
                              <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href=" {{ URL::to('/category/'.$data->category_name.'/'.$data->category_id )}} "> {{ $data->category_name}} </a></h4>
                                </div>
                              </div>
                              @endforeach
                            @endif
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    @if($result=DB::table('manufacture')->where('publication_status',1)->get())
                                        @foreach($result as $data)
                                            ...
                                            <li><a href=" {{ URL::to('/brands/'. $data->manufacture_name .'/'. $data->manufacture_id) }} "><span class="pull-right"></span> {{ $data->manufacture_name}} </a></li>

                                        @endforeach
                                    @endif
                                    <li>
                                        <a href="">
                                            <span class="pull-right">More Brands...</span>
                                        </a>
                                    </li>
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="{{ url('user/images/home/shipping.jpg')}}" alt="" />
                        </div><!--/shipping-->
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    ...
                                    <img src="{{ url('user/images/home/iframe1.png')}}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                    <img src="{{ url('user/images/home/iframe2.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                    <img src="{{ url('user/images/home/iframe3.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                    <img src="{{ url('user/images/home/iframe4.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="address">
                        <img src="{{ url('user/images/home/map.png')}}" alt="" />
