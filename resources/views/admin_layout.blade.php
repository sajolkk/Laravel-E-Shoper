	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href=""><span>Eshoper</span></a>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{ URL::to('all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categorys </span></a></li>

								<li><a class="submenu" href="{{ URL::to('add-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category </span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{ URL::to('all-manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufacture </span></a></li>

								<li><a class="submenu" href="{{ URL::to('add-manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufacture  </span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{ URL::to('all-slider')}}"><i class="icon-edit"></i><span class="hidden-tablet"> All Slider </span></a></li>
						...
						<li><a href="{{ URL::to('shop-name')}}"><i class="icon-font"></i><span class="hidden-tablet"> Shop Name </span></a></li>

						<li><a href="{{ URL::to('delivery-man')}}"><i class="icon-picture"></i><span class="hidden-tablet"> Delivery Man </span></a></li>
